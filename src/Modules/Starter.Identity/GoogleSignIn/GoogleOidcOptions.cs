...
/// <summary>
/// Google OIDC settings, bound from the Auth:Google section.
/// The client secret lives only in its designated homes (dotnet
/// user-secrets locally, a managed secret store in production) - never in a
...
internal sealed class GoogleOidcOptions
{
    ...
    /// exists for the integration suite's fake issuer (the flow is
